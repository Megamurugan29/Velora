    ...
    return [
        {
            ...
            price: 5999,
            discountPrice: 4499,
            image: '../images/products/royal-silk-emerald.jpg',
            ...
            rating: 4.5,
            reviews: 24,
            description: 'Premium silk kurti with intricate embroidery',
            isFeatured: true,
            isBestseller: true,
            isNewArrival: false
        },
        {
            ...
            price: 3999,
            discountPrice: 2999,
            image: '../images/products/premium-silk-maroon.jpg',
            imageFallback: '../images/products/placeholder-kurti.svg',
            fabric: 'silk',
            color: 'maroon',
            sizes: ['S', 'M', 'L', 'XL', 'XXL'],
            rating: 4.8,
            reviews: 42,
            description: 'Luxurious premium silk in deep maroon shade',
            isFeatured: true,
            isBestseller: false,
            isNewArrival: true
        },
        {
            ...
            price: 6999,
            discountPrice: 5499,
            image: '../images/products/festive-gold-kurti.jpg',
            imageFallback: '../images/products/placeholder-kurti.svg',
            fabric: 'blend',
            color: 'champagne',
            sizes: ['XS', 'S', 'M', 'L'],
            rating: 4.7,
            reviews: 31,
            description: 'Perfect for festivals with champagne gold accents',
            isFeatured: false,
            isBestseller: true,
            isNewArrival: false
        },
        {
            ...
            price: 1999,
            discountPrice: 1499,
            image: '../images/products/casual-cotton-ivory.jpg',
            imageFallback: '../images/products/placeholder-kurti.svg',
            fabric: 'cotton',
            color: 'ivory',
        ...
        },
        {
            ...
            price: 5499,
            discountPrice: 3999,
            image: '../images/products/royal-blue-silk.jpg',
            imageFallback: '../images/products/placeholder-kurti.svg',
            fabric: 'silk',
            color: 'sapphire',
            sizes: ['S', 'M', 'L', 'XL'],
            rating: 4.6,
            reviews: 29,
            description: 'Regal sapphire blue silk kurti',
            isFeatured: true,
            isBestseller: false,
            isNewArrival: true
        },
        {
            ...
            price: 4499,
            discountPrice: 3299,
            image: '../images/products/premium-georgette.jpg',
            imageFallback: '../images/products/placeholder-kurti.svg',
            fabric: 'georgette',
            color: 'maroon',
            sizes: ['XS', 'S', 'M', 'L', 'XL'],
            rating: 4.4,
            reviews: 22,
            description: 'Elegant georgette with flowing design',
            isFeatured: false,
            isBestseller: false,
            isNewArrival: false
        }
